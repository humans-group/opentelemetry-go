module github.com/humans-group/otel/example/prometheus
...
require (
	...
	github.com/humans-group/otel/exporters/prometheus v0.38.1
...
replace github.com/humans-group/otel/exporters/prometheus => ../../exporters/prometheus
