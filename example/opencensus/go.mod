module github.com/humans-group/otel/example/opencensus

go 1.19

replace (
	github.com/humans-group/otel => ../..
	github.com/humans-group/otel/bridge/opencensus => ../../bridge/opencensus
...
require (
	...
	github.com/humans-group/otel/exporters/stdout/stdoutmetric v0.38.1
...
replace github.com/humans-group/otel/exporters/stdout/stdoutmetric => ../../exporters/stdout/stdoutmetric
