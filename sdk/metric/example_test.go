...
func Example() {
	...
	// data. See exporters in the github.com/humans-group/opentelemetry-go/exporters package
	// for more information.
	reader := metric.NewManualReader()

	// See the github.com/humans-group/opentelemetry-go/sdk/resource package for more
	...
	//
	// See the github.com/humans-group/opentelemetry-go/metric package for more information
