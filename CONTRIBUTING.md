...
```sh
go get -d github.com/humans-group/opentelemetry-go
```

(This may print some warning about "build constraints exclude all Go
files", just ignore it.)

This will put the project in `${GOPATH}/src/github.com/humans-group/opentelemetry-go`. You
...
(Note that `git clone` is *not* using the `github.com/humans-group/opentelemetry-go` name -
...
`github.com/humans-group/opentelemetry-go/trace.TracerConfig` and
`github.com/humans-group/opentelemetry-go/metric.InstrumentConfig`, are intended to be consumed
