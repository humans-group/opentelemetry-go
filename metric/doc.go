...
it is reusable. See [github.com/humans-group/opentelemetry-go/sdk/metric] for the official
...
[github.com/humans-group/opentelemetry-go/metric/embedded]. If an author wants the default
behavior of their implementations to be a compilation failure, signaling to
their users they need to update to the latest version of that implementation,
they need to embed the corresponding interface from
[github.com/humans-group/opentelemetry-go/metric/embedded] in their implementation. For
example,

	import "github.com/humans-group/opentelemetry-go/metric/embedded"
...
they need to embed the API interface directly.
	...
	import "github.com/humans-group/opentelemetry-go/metric"
...
of [github.com/humans-group/opentelemetry-go/metric].
...
[github.com/humans-group/opentelemetry-go/metric/noop]:
	...
	import "github.com/humans-group/opentelemetry-go/metric/noop"
...
[github.com/humans-group/opentelemetry-go/metric/noop] if they choose this default behavior.
That implementation is the only one OpenTelemetry authors can guarantee will
fully implement all the API interfaces when a user updates their API.

[OpenTelemetry documentation]: https://opentelemetry.io/docs/concepts/signals/metrics/
[GetMeterProvider]: https://pkg.go.dev/github.com/humans-group/opentelemetry-go#GetMeterProvider
*/
