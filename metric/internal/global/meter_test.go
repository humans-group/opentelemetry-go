...
func TestMeterProviderDelegatesCalls(t *testing.T) {
	...
	meter := globalMeterProvider.Meter("github.com/humans-group/opentelemetry-go/metric/internal/global/meter_test")
...
func TestMeterDelegatesCalls(t *testing.T) {
	...
	m := globalMeterProvider.Meter("github.com/humans-group/opentelemetry-go/metric/internal/global/meter_test")
