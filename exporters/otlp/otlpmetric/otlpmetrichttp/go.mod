module github.com/humans-group/opentelemetry-go/exporters/otlp/otlpmetric/otlpmetrichttp
...
replace github.com/humans-group/opentelemetry-go/exporters/otlp/otlpmetric => ../
