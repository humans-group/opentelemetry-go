module github.com/humans-group/otel/bridge/opentracing/test

go 1.19

replace github.com/humans-group/otel => ../../..

replace github.com/humans-group/otel/bridge/opentracing => ../
...
require (
	...
	github.com/humans-group/otel/bridge/opentracing v1.15.1
