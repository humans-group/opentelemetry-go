module github.com/humans-group/opentelemetry-go/bridge/opentracing/test

go 1.19

replace github.com/humans-group/opentelemetry-go => ../../..

replace github.com/humans-group/opentelemetry-go/bridge/opentracing => ../
...
require (
	...
	github.com/humans-group/opentelemetry-go/bridge/opentracing v1.15.5
